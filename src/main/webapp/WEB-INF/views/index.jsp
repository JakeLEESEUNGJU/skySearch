...
<!--       <link rel="icon" type="image/png" href="images/favicon.png'/>"> -->
  ...
  <!-- Bootstrap core CSS -->
      ...
      <!-- Select2 CSS -->
      <link type="text/css" href="<c:url value='/resources/vendor/select2/css/select2-bootstrap.css'/>" rel="stylesheet" />
      <link type="text/css" href="<c:url value='/resources/vendor/select2/css/select2.min.css'/>" rel="stylesheet" />
      <!-- Custom styles for this template -->
      <link type="text/css" href="<c:url value='/resources/css/osahan.css'/>" rel="stylesheet"/>
   ...
   <body>
      ...
      <header>
         <nav class="navbar navbar-expand-lg navbar-light bg-light">
            <div class="container">
               <a class="navbar-brand text-success logo" href="<c:url value='/'/>"><i class="mdi mdi-home-map-marker"></i> <strong>Osahan</strong> Land</a>
         ...
         <div class="container">
            <div class="row">
               <div class="col-lg-4 col-md-3">
                  <h4 class="mb-5"><a class="text-success logo" href="<c:url value='/'/>"><i class="mdi mdi-home-map-marker"></i> <strong>Osahan</strong>Land</a></h4>
